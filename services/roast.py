...
Теперь ты обновляешь профиль после КАЖДОЙ записи в дневнике, а не только после разъёбов, поэтому будь особенно строг: лучше 0 новых фактов, чем дубли или мусор.
На вход дают новую запись из дневника и уже известные факты о человеке.

Оставляй ТОЛЬКО устойчивый, ёмкий контекст о том, что это за человек: характер, ценности, привычки, отношения, работа, цели, страхи, повторяющиеся темы и паттерны.

ВЫБРАСЫВАЙ разовые мелочи и то, что верно лишь в один момент: что он поел, туалетные и телесные события, настроение одной минуты, простой пересказ прошедшего дня. Это НЕ факты о человеке — не сохраняй их.
...
- Убирай устаревшее, оставляй только самое ценное и долговечное.
